...
local AstKind = {
	...
	ShiftLeftStatement = "ShiftLeftStatement";
	ShiftRightStatement = "ShiftRightStatement";
	BitwiseAndStatement = "BitwiseAndStatement";
	BitwiseOrStatement = "BitwiseOrStatement";
	BitwiseXorStatement = "BitwiseXorStatement";
	BitwiseNotStatement = "BitwiseNotStatement";
	BitwiseShiftLeftStatement = "BitwiseShiftLeftStatement";
	BitwiseShiftRightStatement = "BitwiseShiftRightStatement";
...
local astKindExpressionLookup = {
	...
	[AstKind.BitOrExpression] = 9;
	[AstKind.BitXorExpression] = 9;
	[AstKind.BitAndExpression] = 9;
	[AstKind.BitwiseShiftLeftExpression] = 9;
	[AstKind.BitwiseShiftRightExpression] = 9;
	[AstKind.BitwiseNotExpression] = 5;
	...
	[AstKind.RadExpression] = 5;
	[AstKind.ExpExpression] = 5;
	[AstKind.LogExpression] = 5;
	[AstKind.DegExpression] = 5;
}
...
function Ast.ShiftLeftStatement(lhs, rhs)
	return {
		kind = AstKind.ShiftLeftStatement,
		lhs = lhs,
		rhs = rhs,
	}
end

function Ast.ShiftRightStatement(lhs, rhs)
	return {
		kind = AstKind.ShiftRightStatement,
		lhs = lhs,
		rhs = rhs,
	}
end

function Ast.BitwiseAndStatement(lhs, rhs)
	return {
		kind = AstKind.BitwiseAndStatement,
		lhs = lhs,
		rhs = rhs,
	}
end

function Ast.BitwiseOrStatement(lhs, rhs)
	return {
		kind = AstKind.BitwiseOrStatement,
		lhs = lhs,
		rhs = rhs,
	}
end

function Ast.BitwiseXorStatement(lhs, rhs)
	return {
		kind = AstKind.BitwiseXorStatement,
		lhs = lhs,
		rhs = rhs,
	}
end

function Ast.BitwiseNotStatement(rhs)
	return {
		kind = AstKind.BitwiseNotStatement,
		rhs = rhs,
	}
end

function Ast.BitwiseShiftLeftStatement(lhs, rhs)
	return {
		kind = AstKind.BitwiseShiftLeftStatement,
		lhs = lhs,
		rhs = rhs,
	}
end

function Ast.BitwiseShiftRightStatement(lhs, rhs)
	return {
		kind = AstKind.BitwiseShiftRightStatement,
		lhs = lhs,
		rhs = rhs,
	}
end
...
-- Create Goto Statement (Lua 5.4)
function Ast.GotoStatement(label, scope)
	return {
...
-- Create Label Statement (Lua 5.4)
function Ast.LabelStatement(label, scope)
	return {
...
function Ast.ForInStatement(scope, vars, expressions, body, parentScope, attributes)
	return {
...
function Ast.BitwiseShiftLeftExpression(lhs, rhs, simplify)
	return {
		kind = AstKind.BitwiseShiftLeftExpression,
		lhs = lhs,
		rhs = rhs,
		isConstant = false,
	}
...
function Ast.BitwiseShiftRightExpression(lhs, rhs, simplify)
	return {
		kind = AstKind.BitwiseShiftRightExpression,
		lhs = lhs,
		rhs = rhs,
		isConstant = false,
	}
...
function Ast.RadExpression(rhs, simplify)
	return {
		kind = AstKind.RadExpression,
		rhs = rhs,
		isConstant = false,
	}
end

function Ast.ExpExpression(rhs, simplify)
	return {
		kind = AstKind.ExpExpression,
		rhs = rhs,
		isConstant = false,
	}
end

function Ast.LogExpression(rhs, simplify)
	return {
		kind = AstKind.LogExpression,
		rhs = rhs,
		isConstant = false,
	}
end

function Ast.DegExpression(rhs, simplify)
	return {
		kind = AstKind.DegExpression,
		rhs = rhs,
		isConstant = false,
	}
end
